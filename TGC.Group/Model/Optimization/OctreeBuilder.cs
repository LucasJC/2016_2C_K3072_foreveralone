...
namespace TGC.Group.Model.Optimization
{
    ...
    internal class OctreeBuilder
    {
        ...
        private readonly int MIN_MESH_PER_LEAVE_THRESHOLD = 15;

        public OctreeNode crearOctree(List<InteractiveObject> modelos, TgcBoundingAxisAlignBox sceneBounds)
        {
        ...
        private void doSectorOctreeX(OctreeNode parent, Vector3 center, Vector3 size,
            int step, List<InteractiveObject> meshes)
        {
            var x = center.X;
